...
class OBJECT_HAE(BaseNet):
    ...
    def __init__(self):
        ...
        self.conv0 = nn.Conv2d(3, 8, 4, stride=2, padding=1, bias=True)
        self.bn0 = nn.BatchNorm2d(8, eps=1e-04, affine=False)

        self.conv1 = nn.Conv2d(8, 32, 4, stride=2, padding=1, bias=True)
        ...
        self.deconv0 = nn.ConvTranspose2d(8, 3, 4, stride=2, padding=1, bias=True)
        self.debn0 = nn.BatchNorm2d(3, eps=1e-04, affine=False)

        self.deconv1 = nn.ConvTranspose2d(32, 8, 4, stride=2, padding=1, bias=True)
        self.debn1 = nn.BatchNorm2d(8, eps=1e-04, affine=False)

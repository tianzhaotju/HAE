...
class TEXTURE_HAE(BaseNet):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 4, stride=2, padding=1, bias=True)
        ...
        self.deconv1 = nn.ConvTranspose2d(32, 3, 4, stride=2, padding=1, bias=True)
        self.debn1 = nn.BatchNorm2d(3, eps=1e-04, affine=False)
    ...
    def forward(self, input_x):
        ...
        rep_1 = F.relu(self.bn1(x))
        # rep_1 = F.relu(x)
        x = self.deconv1(rep_1)
        # rep_0_reco = F.relu(x)
        # x_reco = F.relu(self.debn0(x))
        rep_0_reco = torch.sigmoid(x)

        x = self.conv2(rep_1)
        rep_2 = F.relu(self.bn2(x))
        # rep_2 = F.relu(x)
        rep_1_reco = self.deconv2(rep_2)
        # rep_1_reco = F.relu(x)
        rep_1_reco = self.deconv1(rep_1_reco)
        # rep_1_reco = F.relu(rep_1_reco)

        # x_reco = F.relu(self.debn0(x))
        rep_1_reco = torch.sigmoid(rep_1_reco)

        x = self.conv3(rep_2)
        rep_3 = F.relu(self.bn3(x))
        rep_2_reco = self.deconv3(rep_3)
        ...
        x = self.conv4(rep_3)
        rep_4 = F.relu(self.bn4(x))
        rep_3_reco = self.deconv4(rep_4)
        ...
        x = self.conv5(rep_4)
        rep_5 = F.relu(self.bn5(x))
        rep_4_reco = self.deconv5(rep_5)
        ...
        x = self.conv6(rep_5)
        rep_6 = F.relu(self.bn6(x))
        rep_5_reco = self.deconv6(rep_6)
        ...
        x = self.conv7(rep_6)
        rep_7 = F.relu(self.bn7(x))
        rep_6_reco = self.deconv7(rep_7)
        ...
        x = self.conv8(rep_7)
        rep_8 = F.relu(self.bn8(x))
        rep_7_reco = self.deconv8(rep_8)
        ...
        x = self.conv9(rep_8)
        rep_9 = F.relu(self.bn9(x))
        rep_8_reco = self.deconv9(rep_9)
        ...
        return rep_0_reco, rep_1_reco, rep_2_reco, rep_3_reco, rep_4_reco, \
               rep_5_reco, rep_6_reco, rep_7_reco, rep_8_reco, rep_9_reco


class TEXTURE_HAE_Autoencoder(BaseNet):
    ...
    def forward(self, rep_0):
        ...
        #return rep_0, rep_0_reco, rep_1, rep_1_reco, rep_2, rep_2_reco, rep_3, rep_3_reco, rep_4, rep_4_reco, \
        #       rep_5, rep_5_reco, rep_6, rep_6_reco, rep_7, rep_7_reco, rep_8, rep_8_reco, rep_9, rep_9_reco, rep_10
        return  rep_0-rep_0_reco, rep_1, rep_2, rep_3, rep_4, rep_5, rep_6, rep_7, rep_8, rep_9
...
# python src/main.py texture texture_hae ./log/texture ./data/Mvtec_data_presentation/ --objective deep-GMM --lr 0.0001 --n_epochs 1 --lr_milestone 50 --batch_size 200 --weight_decay 0.5e-6 --pretrain True --seed -1 --ae_lr 0.0001 --ae_lr_milestone 50 --ae_batch_size 16 --ae_weight_decay 0.5e-3 --ae_loss_type 'texture_HAE' --ae_only True --normal_class 0 --ae_n_epochs 4000 --device cuda:0 --ae_test_only True
# python src/main.py object object_hae ./log/object ./data/Mvtec_data_presentation/ --objective deep-GMM --lr 0.0001 --n_epochs 1 --lr_milestone 50 --batch_size 200 --weight_decay 0.5e-6 --pretrain True --seed -1 --ae_lr 0.0001 --ae_lr_milestone 50 --ae_batch_size 16 --ae_weight_decay 0.5e-3 --ae_loss_type 'object_HAE' --ae_only True --normal_class 5 --ae_n_epochs 2200 --device cuda:0 --ae_test_only True